...
- Fixture 101 `Front Left Wash`: type=Robe LEDWash 600, patch=1.1, cues=2, hard atoms=3
...
## Consistency issues
- mixed_control_mode: Robe LEDWash 600 / Dimmer | severity=medium | hard_atoms=2, preset_refs=1, fixtures=2, cues=2

## Risk hotspots
- Seq 1 Cue 1 Blackout: score=2 | mixed hard and preset control

## Worst cues
- Seq 1 Cue 1 `Blackout`: score=24 | hard-heavy cue (4 hard values); mixed fixture control on 1 fixtures
- Seq 1 Cue 2 `Build`: score=0 | stable cue profile

## Fixture inconsistency
- Fixture 101 `Front Left Wash` / Dimmer: hard=2, preset=1 | family uses both hard and preset control across 2 cues
