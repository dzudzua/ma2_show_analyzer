...
- Cue 1 `Blackout`: H=3, D=1, fixtures=3, fade=0, trigger=go
- Cue 2 `Build`: H=2, D=1, fixtures=3, fade=2, trigger=follow

## Top fixtures by cue usage
- Fixture 101 `Front Left Wash`: type=Robe LEDWash 600, patch=1.1, cues=2, H=0, D=3
- Fixture 102 `Front Center Wash`: type=Robe LEDWash 600, patch=1.17, cues=2, H=1, D=0
- Fixture 103 `DS Center Spot`: type=Martin MAC Viper, patch=1.33, cues=2, H=1, D=0
